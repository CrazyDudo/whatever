...
public class DbOpenHelper extends SQLiteOpenHelper {
    ...
    public static final String TEST_RESULT_TABLE_NAME = "result";
    ...
    private String CREATE_TEST_RESULT_TABLE = "CREATE TABLE IF NOT EXISTS "
            + TEST_RESULT_TABLE_NAME + "( _id INTEGER PRIMARY KEY," + "factorymode1 INT ," + "agingtest INT)";
